...
<%--                                                <td>
                                    ...
                                    <input type="hidden" value="" id="itemEachPage" name="itemEachPage"/>
...
<script>
    ...
    $(function () {
        window.pagObj = $('#pagination').twbsPagination({
            ...
            visiblePages: 5, // number of buttons
            startPage: currentPage,
            onPageClick: function (event, page) {
                if (currentPage != page) {
                    $('#itemEachPage').val(limit);
                    $('#page').val(page);
                    $('#sortField').val('title');
                    $('#sortBy').val('desc');
                    $('#type').val('list');
    ...
    function deleteNew(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${NewURL}?type=list&itemEachPage=2&page=1&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${NewURL}?type=list&itemEachPage=2&page=1&message=error_system";
            }
        });
    }*/
</script>
